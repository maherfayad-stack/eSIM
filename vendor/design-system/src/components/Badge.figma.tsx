...
figma.connect(Badge, 'https://www.figma.com/design/8nasqgUrdKsT8JgQRBHwPB/Styles---Components?node-id=REPLACE-ME', {
  props: {
    variant: figma.enum('Variant', { Alert: 'alert', New: 'new' }),
  },
  example: ({ variant }) => <Badge variant={variant} count={3} />,
})
