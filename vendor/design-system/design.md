...
| `secondary-inverted` | Muted secondary action on a light surface (e.g. inside a card) | As needed |
...
| `apple-pay` | Apple Pay payment confirmation | Once, in payment flows only |
